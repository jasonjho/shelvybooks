...
export function ViewingFriendPill({ viewedUser, onClose }: ViewingFriendPillProps) {
  return (
    // Use larger offset on mobile (5.5rem) since header can be taller; desktop uses 4.5rem
    <div className="fixed top-[5.5rem] sm:top-[4.5rem] left-1/2 -translate-x-1/2 z-30 animate-in fade-in slide-in-from-top-2 duration-200">
